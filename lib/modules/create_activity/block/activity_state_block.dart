...
class CreateActivityStateCubit extends Cubit<CreateActivityState> {
  ...
  void setadditionalInformation(value) {
    emit(state.copyWith(additionalInformation: value));
  }

  void setrequirements(value) {
  ...
  void setImages(value) {
    emit(state.copyWith(images: value));
  }

  void setUsersLvl(value) {
    emit(state.copyWith(usersLvl: value));
  }
  ...
  void addCategory(String activityCategoryId) {
    ...
    emit(state.copyWith(categories: listCopy));
  }
  ...
  void decreaseMaxParticipantsCounter() {
    ...
    emit(state.copyWith(maxParticipants: state.maxParticipants - 1));
  }
