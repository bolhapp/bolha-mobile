...
import 'package:bolha/modules/shared/components/activity_skill_selector.dart';
        ...
        return BlocProvider<SignUpStepTwoPageFormCubit>.value(
            ...
            child: ActivitySelectDialog(
              checkIfSelected: (element) => context
                  .read<SignUpStepTwoPageFormCubit>()
                  .state
                  .activities
                  .any((type) => type.activityTag == element),
              handleListSelect: (p0) {
                if (context
                    .read<SignUpStepTwoPageFormCubit>()
                    .state
                    .activities
                    .any((d) => d.activityTag == p0)) {
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            for (var item
                in context.watch<SignUpStepTwoPageFormCubit>().state.activities)
              ActivitySkillSelector(
                ...
                handleDelete: (data) => context
                    .read<SignUpStepTwoPageFormCubit>()
                    .deleteActivity(data),
                handleSkillLvlIncrease: (data) => context
                    .read<SignUpStepTwoPageFormCubit>()
                    .increaseActivitySkillLvl(data),
                handleSkillLvlDecrease: (data) => context
                    .read<SignUpStepTwoPageFormCubit>()
                    .decreaseActivitySkillLvl(data),
              ),
            TextButton(
                style: ButtonStyle(
